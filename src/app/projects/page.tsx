    ...
    <div>
      ...
      <div className="mt-12 columns-1 lg:columns-2 gap-8">
        {projects.map(project => (
          <a key={project.name} href={project.github} target="_blank" className="group relative overflow-hidden">
            <Image src={project.preview} alt={project.name} className="mb-8 rounded-lg" />
            <div className="lg:opacity-0 group-hover:opacity-100 transition-opacity w-full absolute bottom-0 rounded-lg flex flex-col gap-2 pt-20 px-4 pb-4 bg-gradient-to-b from-transparent to-black">
