...
export default function Home() {
  return (
    <div className="flex flex-col gap-8 leading-8">
      ...
      <p>Software Engineer based in Indonesia. Passionate about solving problems with software solutions and eager to continuously learn new things. Enjoys exploring new technologies and improving coding skills.</p>
